...
The 0.3 cohort is open to independent professionals, small and medium-sized
organizations, nonprofits, and public services in Switzerland and the European
...
1. one non-agentic or copilot workflow, such as retrieval, classification,
...
Without such a report, agency-level field performance remains unproven.

Three reports are a learning threshold, not statistical validation. They do
not create a universal productivity benchmark.

## Participation path

1. **Screen.** Open a public intake with an alias, use pattern, territory,
   bounded workflow, current stage, and decision question.
...
Every pilot records the complete workload and the share that was actually
eligible for AI. Common measures are accepted outcomes, human time, major
corrections, critical incidents, trace completeness, and implementation effort.
The evaluation profile then changes with the use pattern:
...
- Admitted reports: 0
- Public registry: [`field-notes/index.json`](../field-notes/index.json)

An intake, an active pilot, or a draft report does not change the admitted
count. The count changes only after independent review and publication.
