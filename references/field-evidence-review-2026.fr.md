...
Cette revue décrit la méthode en toutes lettres. Elle n’utilise plus une seconde
échelle A à E : les [grades du registre temporel](../docs/task-time-evidence.fr.md)
décrivent la base de mesure d’un chiffre de temps, pas tous les résultats
d’une étude. Une comparaison contrôlée, une mesure opérationnelle, un temps
déclaré et un test de capacité répondent à des questions différentes.
...
heures humaines nettes après IA =
  travail sur les cas non automatisés
+ travail humain restant sur les cas traités avec IA
+ charges supplémentaires non déjà comptées (installation, suivi, incidents)

heures humaines économisées =
  heures humaines avant IA - heures humaines nettes après IA
```

Comptez chaque minute une seule fois. La revue, les corrections et les exceptions
font partie du travail restant, y compris pour les cas échoués ou repris manuellement.
Par exemple, 100 heures avant et 60 heures après donnent 40 heures économisées.
