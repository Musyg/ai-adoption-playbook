...
| [Agentic AI in customer service](https://arxiv.org/abs/2605.14830) | Sur 680 676 conversations, l’agent réduit de 16,8 % la durée des cas éligibles. Ces cas ne représentent que 5,8 % du flux, le gain global est 3,2 % et la note client baisse sur les cas éligibles. | Essai randomisé direct sur un agent borné, mais pendant 17 jours, dans un support standardisé et avec un superviseur humain pour chaque cas. |
| [The Uneven Impact of Generative AI](https://www.hbs.edu/ris/download.aspx?name=24-042.pdf) | Sur 640 petites entreprises, le conseil IA produit un effet moyen non significatif. Les meilleurs au départ gagnent environ 15 % et les plus faibles perdent environ 8 %. | Essai randomisé pertinent pour les petites structures, mais sur du conseil non connecté plutôt que sur un agent métier. |
...
| [Microsoft Research, CORPGEN](https://www.microsoft.com/en-us/research/blog/corpgen-advances-ai-agents-for-real-work/) | Avec 46 tâches concurrentes, l’architecture hiérarchique atteint 15,2 % de réalisation contre 4,3 % pour les baselines. Le gain relatif est 3,5, mais le taux absolu reste 15,2 %. | Benchmark simulé de six heures ; utile pour refuser d'extrapoler un gain de workflow borné à une agence en production. |
...
Le cas Noroît utilise des hypothèses préenregistrées de **50 à 75 %** de
réduction sur **60 à 85 %** de demandes éligibles. Ce sont des valeurs de
démonstration volontairement ambitieuses, pas une plage établie par la
littérature. Elles doivent être contestées sur un jeu gelé puis remplacées par
les observations du pilote. Le calibrateur général commence désormais avec des
hypothèses plus conservatrices et entièrement modifiables.
