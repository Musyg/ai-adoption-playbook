...
const guidedContent: Record<Locale, GuidedContent> = {
  en: {
    ...
    text: "Move through four short screens, then receive a starting plan. The operating-design screen contains three separate choices. The guide explains each idea before showing a technical code. Nothing entered here is sent anywhere.",
    ...
    steps: [
      ...
      { eyebrow: "YOUR STARTING POINT", title: "A small first step, with clear limits.", text: "This recommendation combines the choices in your route. It is a starting hypothesis to test, not an authorization or a promised gain.", helpLabel: "What is an evidence contract?", help: "Before the pilot, write what will be tested, on which cases, what counts as success, what stops the test, and which records must remain. That written agreement is the evidence contract." },
    ],
    levels: [
  ...
  fr: {
    ...
    text: "Parcourez quatre écrans courts, puis obtenez un point de départ. L’écran de fonctionnement contient trois choix distincts. Le guide explique chaque idée avant d’afficher un code technique. Rien de ce qui est saisi ici n’est transmis.",
...
const copy = {
  ...
  fr: {
    ...
    operationsText: "Transformez la décision en responsabilités nommées, fenêtres de surveillance, déclencheurs d’arrêt fermes, retour arrière reproductible et réévaluation datée. Tout changement de modèle, outil, permission, règle ou donnée rouvre la question de la preuve.",
    operationStates: {
    ...
    operationRollback: [["01", "Contenir", "Arrêter l’entrée et révoquer ou désactiver l’exécution capable d’écrire."], ["02", "Rediriger en sécurité", "Envoyer les cas en attente et les nouveaux cas vers la solution manuelle testée."], ["03", "Préserver", "Figer les journaux, versions, validations, reçus d’outils, destinations et horodatages."], ["04", "Réconcilier", "Relire l’état externe, identifier chaque effet, réparer ce qui est réversible sans risque et transmettre le reste à la personne responsable."], ["05", "Réautoriser", "Ne reprendre qu’après consignation de la cause, correction, preuves rejouées et nouvelle décision."],],
