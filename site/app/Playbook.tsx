...
const copy = {
  en: {
    ...
    publicText: "This fictional Swiss municipality tests an A2 agent on administrative completeness—not planning judgment. The workflow can move faster only if mandate, procurement, evidence, public notice, appeal, archives, and a no-AI service path move with it.",
    publicBadge: "62,000 residents · 17-person service · 90 days · fictional",
    publicProblem: "The City of Mont-Rive receives 1,080 planning applications per year in French and German. The agent inventories documents, extracts source-cited administrative facts, applies a published checklist, and—after officer approval—sends, records, and routes. It never declares completeness, interprets law, or recommends approval, refusal, conditions, or priority.",
  ...
  fr: {
    ...
    publicProblem: "La Ville de Mont-Rive reçoit 1 080 demandes d’autorisation par an en français et en allemand. L’agent inventorie les pièces, extrait des faits administratifs cités, applique une checklist publiée puis — après approbation — envoie, enregistre et attribue. Il ne déclare jamais la complétude, n’interprète pas le droit et ne recommande ni octroi, ni refus, ni condition, ni priorité.",
    ...
    <div className="page-shell">
      ...
      <main id="main">
        ...
        <section className="public-case section-blue" id="public-case" aria-labelledby="public-case-title">
          ...
          <div className="public-decision"><div><p className="eyebrow">P5 · {locale === "en" ? "FORMAL PRODUCTION DECISION" : "DÉCISION FORMELLE DE PRODUCTION"}</p><h3>{t.publicDecision}</h3><p>{t.publicDecisionText}</p></div><a className="button primary" href={`${repository}/blob/agent/add-visual-playbook/${locale === "en" ? "examples/en/public-sector-planning-dossier-business-agent.md" : "examples/fr/service-public-agent-dossiers-urbanisme.md"}`}>{t.publicCta} ↗</a></div>
        </section>
