...
const contextLabels = {
  en: { organization_type: "Organization type", use_pattern: "AI use pattern", jurisdiction: "Territory", integration_level: "Work mode", work_mode: "Work mode", architecture: "Architecture", autonomy_level: "Exact action boundary", risk_level: "Risk orientation" },
  fr: { organization_type: "Type de structure", use_pattern: "Mode d’usage de l’IA", jurisdiction: "Territoire", integration_level: "Mode de travail", work_mode: "Mode de travail", architecture: "Architecture", autonomy_level: "Limite d’action exacte", risk_level: "Orientation du risque" },
};
...
function phaseFor(item: ChangeReviewItem, props: Props) {
  ...
  if (group === "context") return ["jurisdiction", "risk_level"].includes(id) ? 4 : ["integration_level", "work_mode", "architecture", "autonomy_level"].includes(id) ? 5 : 0;
...
function displayValue(value: string, item: ChangeReviewItem, props: Props) {
  ...
  if (group === "context") {
    const maps: Record<string, Record<string, string>> = {
      organization_type: props.locale === "en" ? { independent: "Independent", tpe: "Micro-business", pme: "SME", nonprofit: "Nonprofit / foundation", public: "Public service" } : { independent: "Indépendant", tpe: "TPE", pme: "PME", nonprofit: "Association / fondation", public: "Service public" },
      use_pattern: props.locale === "en" ? { generation: "Generation", retrieval: "Retrieval", classification: "Extraction and classification", prediction: "Prediction and recommendation", conversation: "Conversation", multimodal: "Multimodal", agentic: "Agentic action" } : { generation: "Génération", retrieval: "Recherche augmentée", classification: "Extraction et classification", prediction: "Prédiction et recommandation", conversation: "Conversation", multimodal: "Multimodal", agentic: "Action avec des outils" },
