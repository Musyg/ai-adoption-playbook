  ...
  en: [
    {
      ...
      fields: [
        ...
        { id: "work_mode", label: "Work mode", help: "How people and AI share the work: copilot, bounded automation, or strong automation.", required: true },
        { id: "architecture", label: "Architecture", help: "What the system contains, independently of its authority.", required: true },
        { id: "autonomy_level", label: "Exact action boundary", help: "A0 to A4: what the system may do without a person carrying each step.", required: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "autonomy_level", label: "Exact action boundary", help: "Freeze the exact A0 to A4 authority tested.", required: true },
  ...
  fr: [
    {
      ...
      fields: [
        ...
        { id: "work_mode", label: "Mode de travail", help: "Comment les personnes et l’IA se partagent le travail : copilote, automatisation bornée ou forte.", required: true },
        { id: "architecture", label: "Architecture", help: "Ce que contient le système, indépendamment de son autorité.", required: true },
        { id: "autonomy_level", label: "Limite d’action exacte", help: "A0 à A4 : ce que le système peut faire sans qu’une personne réalise chaque étape.", required: true },
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "autonomy_level", label: "Limite d’action exacte", help: "Figez l’autorité exacte A0 à A4 testée.", required: true },
